                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="{{'/manager/product/delete/'.$product->id}}"
                                                            method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{'/manager/product/update/'.$product->id}}"
                                                        method="POST">
                                                        @csrf
              ...
              <input required type="text" name="product_id" class="form-control" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="bmd-label-floating">Product
                                                                            Brand</label>
                                                                        <input required type="text" name="product_brand"
                                                                            class="form-control" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="bmd-label-floating">Location</label>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="bmd-label-floating">Select
                                                                            Categories</label>
                                                                        <select name="product_category" id="categories"
                                                                            class="form-control" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input required type="number" id="quantity"
                                                                            name="product_price" min="1" step="any"
                                                                            class="form-control" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="bmd-label-floating">Quantity</label>
                                                                        <input required type="number" id="quantity"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="bmd-label-floating">Lorem
