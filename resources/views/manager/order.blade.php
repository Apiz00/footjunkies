    ...
    <div class="content">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{'/manager/order/fulfilled/'.$order->id}}">
                    <div class="modal-body">
                        @csrf
                        <div class="confirmation">
                            <label for="yes_no_radio">Are you sure this product is fulfilled?</label>
                            <div class="row">
                                <p class="col-lg-2">
                                    <input type="radio" name="fulfillment" value="1" checked>Yes</input>
                                </p>
                                <p class="col-lg-2">
                                    <input type="radio" name="fulfillment" value="0">No</input>
                                </p>
