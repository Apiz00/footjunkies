        ...
        <div class="container-fluid">
            ...
            <div class="row">
                                ...
                                <div class="tab-pane active" id="profile">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <form action="{{'/admin/task/delete/'.$task->id}}" method="POST">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
                                            <tr>
                                                <td>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-header card-header-warning">
                            <h4 class="card-title">Shops Stats</h4>
                            <p class="card-category">
                                New shops on 15th September, 2016
                            </p>
                        </div>
