    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                <a class="navbar-brand" href="javascript:;">Shops List</a>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    >
                      Open modal for @getbootstrap
                                ...
                                {{-- <a href="#">
                                    <i class="pull-right material-icons" data-toggle="modal" data-target="#exampleModal"
                                        style="cursor: pointer">add_box</i></a> --}}
                            </p>
                        </div>
                        <!-- Modal -->
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">Shop ID:</label>
                                            ...
                                            <div class="form-group">
                                                <label for="message-text" class="col-form-label">SSM Number:</label>
