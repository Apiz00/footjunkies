              ...
              <ul>
                ...
                <li>
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="active">
                      <a href="/orderstracking">Orders Tracking</a>
                    </li>
                  </ul>
                </li>
    ...
    <div class="container" style="margin-bottom: 21%;">
      <div class="row" style="margin-top: 10%;">
        <div class="col-lg-12 text-center mb-5">
          <h2 class="mb-5">ORDERS TRACKING</h2>
        ...
        <div class="col-lg-12 text-center mt-5 mb-5">
          <div class="footer__newslatter">
            ...
            <form action="#">
              <input
                ...
                placeholder="Tracking Id..."
              />
              <button type="submit" onclick="inputTrack()" class="site-btn">
                TRACK
              </button>
            </form>
          ...
          <span>Sample: FE303384515MY</span>
        </div>
      </div>
    </div>
